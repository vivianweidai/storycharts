...
class APIClient {
    ...
    func createPlot(storyId: Int, title: String, description: String) async throws -> CreateResponse {
    ...
    func updatePlot(_ id: Int, title: String, description: String) async throws {
